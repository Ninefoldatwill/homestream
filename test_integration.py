...
from actions import (
    ...
    SendMessageAction, AssignTaskAction, HandoffTaskAction,
)
from observations import (
    create_message_received, create_task_assigned,
    create_task_done_obs, create_error_obs, create_security_obs,
    MessageReceivedObservation, TaskAssignedObservation,
    TaskDoneObservation, ErrorObservation, SecurityObservation,
)
...
def main():
    ...
    print(f"  MessageReceivedObservation: {obs1.observation_type if hasattr(obs1, 'observation_type') else 'N/A'}")
