...
class MessageReceivedObservation(Observation):
    ...
    # ASK v1.1扩展
    ask_id: str | None = Field(None, description="ASK消息ID")
    ask_context: str | None = Field(None, description="ASK上下文")
    ask_deadline: str | None = Field(None, description="ASK截止时间")
...
class ErrorObservation(Observation):
    ...
    fallback_suggestion: str | None = Field(None, description="回退建议")
...
class SecurityObservation(Observation):
    ...
    reason: str | None = Field(None, description="风险原因")
...
def create_security_obs(
    action_id: str, risk_level: str, reason: str | None = None, blocked: bool = False
) -> SecurityObservation:
